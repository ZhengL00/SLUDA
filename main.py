...
def parse_args():
    ...
    parser.add_argument("--eval", action="store_true", default=True, help="evaluation mode")
    ...
    parser.add_argument(
        "--label-prop", action="store_true", default=True, help="use label propagation."
    )
    parser.add_argument("--use-ssl", action="store_true", default=True, help="use SSL.")
    parser.add_argument(
        "--use-phrase-mask", action="store_true", help="use phrase specific masking."
    )
    parser.add_argument(
        "--test_set", default=True, action="store_true", help="use test set for evaluation"
    )

    parser.add_argument("--ssl_loss", type=str, default="", help="fro/contrastive")
    parser.add_argument(
        "--image_features_type",
        type=str,
        default="faster_rcnn",
    ...
    parser.add_argument(
        "--bbox-reg", action="store_true", default=True, help="use bbox regression loss"
    )
    parser.add_argument(
        "--grounding", action="store_true", default=True, help="use grounding alignment loss"
    )
    parser.add_argument(
        "--trans-func",
        action="store_true",
    ...
    parser.add_argument("--image_feature_dim", default=, type=int)
    parser.add_argument(
        "--world_size",
        default=1,
        type=int,
    ...
    parser.add_argument(
        "--model_config", type=str, default="", help="path to model structure config json"
    )
